...
const Home = () => {
  ...
  const doctorsData = [
    ...
    { img: "./images/img/d32.jpg", name: "Dr. Sugaprakash", specialization: "Gynecologist" },
    { img: "./images/img/d32.jpg", name: "Dr. Vasanth", specialization: "Urologist" },
    { img: "./images/img/d32.jpg", name: "Dr. Gerald", specialization: "Oncologist" },
    { img: "./images/img/d32.jpg", name: "Dr. Sivakumar", specialization: "Oncologist" },
